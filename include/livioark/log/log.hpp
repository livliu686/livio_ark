...
#define LOGM_TRACE(module, ...) \
    ::livio::ark::log::log_module((module), ::livio::ark::log::Level::Trace, __VA_ARGS__)
#define LOGM_DEBUG(module, ...) \
    ::livio::ark::log::log_module((module), ::livio::ark::log::Level::Debug, __VA_ARGS__)
#define LOGM_INFO(module, ...) \
    ::livio::ark::log::log_module((module), ::livio::ark::log::Level::Info, __VA_ARGS__)
#define LOGM_WARN(module, ...) \
    ::livio::ark::log::log_module((module), ::livio::ark::log::Level::Warn, __VA_ARGS__)
#define LOGM_ERROR(module, ...) \
    ::livio::ark::log::log_module((module), ::livio::ark::log::Level::Error, __VA_ARGS__)
#define LOGM_CRITICAL(module, ...) \
    ::livio::ark::log::log_module((module), ::livio::ark::log::Level::Critical, __VA_ARGS__)
